...
- Name: checkout/purchase-flow.spec.ts >> Fluxo de compra E2E >> deve realizar o fluxo completo de compra com alteração de quantidade e pagamento na entrega
- Location: tests/checkout/purchase-flow.spec.ts:35:7
...
Locator: locator('.product-block:visible').filter({ hasText: 'Cassia Funnel Sweatshirt' }).first().locator('a[title="Cassia Funnel Sweatshirt"]')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.product-block:visible').filter({ hasText: 'Cassia Funnel Sweatshirt' }).first().locator('a[title="Cassia Funnel Sweatshirt"]')
...
- banner:
    ...
    - list:
        ...
        - listitem:
            - link "Logout":
                - /url: http://lojaebac.ebaconline.art.br/wp-login.php?action=logout&redirect_to=http%3A%2F%2Flojaebac.ebaconline.art.br&_wpnonce=42fb31e1a8
    - link "EBAC – Shop":
...
- main:
    ...
    - figure:
        ...
        - link " ":
            - /url: /produtos/?action=yith-woocompare-add-product&id=10988&_wpnonce=704b3e1280
    ...
    - figure:
        ...
        - link " ":
            - /url: /produtos/?action=yith-woocompare-add-product&id=10987&_wpnonce=704b3e1280
    ...
    - figure:
        ...
        - link " ":
            - /url: /produtos/?action=yith-woocompare-add-product&id=2559&_wpnonce=704b3e1280
    ...
    - figure:
        ...
        - link " ":
            - /url: /produtos/?action=yith-woocompare-add-product&id=3111&_wpnonce=704b3e1280
    ...
    - figure:
        ...
        - link " ":
            - /url: /produtos/?action=yith-woocompare-add-product&id=3073&_wpnonce=704b3e1280
    ...
    - figure:
        ...
        - link " ":
            - /url: /produtos/?action=yith-woocompare-add-product&id=2622&_wpnonce=704b3e1280
    ...
    - figure:
        ...
        - link " ":
            - /url: /produtos/?action=yith-woocompare-add-product&id=3374&_wpnonce=704b3e1280
    ...
    - figure:
        ...
        - link " ":
            - /url: /produtos/?action=yith-woocompare-add-product&id=3528&_wpnonce=704b3e1280
    ...
    - figure:
        ...
        - link " ":
            - /url: /produtos/?action=yith-woocompare-add-product&id=3647&_wpnonce=704b3e1280
...
```ts
  ...
  7  |     this.buyMenu = page.getByRole('link', {
  8  |       name: /comprar/i,
  9  |     });
  10 |   }
  11 |
  ...
  14 |   }
  15 |
  16 |   async goToShop(): Promise<void> {
  17 |     await this.buyMenu.click();
  18 |
  ...
  22 |   }
  23 |
  24 |   async selectProductFromShowcase(
  25 |     productName: string
  26 |   ): Promise<void> {
  27 |     const productCard = this.page
  28 |       .locator('.product-block:visible')
  29 |       .filter({
  30 |         hasText: productName,
  31 |       })
  32 |       .first();
  33 |
  34 |     const productLink = productCard.locator(
  35 |       `a[title="${productName}"]`
  36 |     );
  37 |
> 38 |     await expect(productLink).toBeVisible({
     |                               ^ Error: expect(locator).toBeVisible() failed
  39 |       timeout: 10_000,
  40 |     });
  41 |
  42 |     await productLink.click();
  43 |   }
  44 |
  45 |   async expectProductPage(
  46 |     productSlug: string
  47 |   ): Promise<void> {
  48 |     await expect(this.page).toHaveURL(
  49 |       new RegExp(productSlug)
  50 |     );
  51 |   }
  52 | }
```
