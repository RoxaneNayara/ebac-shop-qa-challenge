...
Locator: locator('.top-cart')
Expected: visible
Error: strict mode violation: locator('.top-cart') resolved to 3 elements:
    1) <div class="active-mobile top-cart">…</div> aka locator('.active-mobile.top-cart')
    2) <div class="pull-right top-cart hidden-xs">…</div> aka locator('.pull-right.top-cart')
    3) <div class="tbay-cart top-cart hidden-xs">…</div> aka locator('.tbay-cart')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('.top-cart')
...
```ts
  ...
  30 |
  31 |     this.cart = page.locator('.top-cart');
  32 |
